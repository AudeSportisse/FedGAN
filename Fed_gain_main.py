...
from show_dataset import plot_indicator_avg_results_m
...
if __name__ == '__main__':
    ...
    training_model = 'One_time'#'Many_time'  # Many_time / One_time

    if training_model == 'Many_time':
        # params_test_list = [25, 40]
        params_test_list = ['(A5_A10_A15)_nCO_321r_One_time']#,
        ...
        dataset_name = '(A5_A10_A15)_nCO_321r_One_time'
